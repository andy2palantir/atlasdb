...
public class CassandraJmxCompactionManagers {
    ...
    public static Set<CassandraJmxCompactionClient> createCompactionClients(CassandraKeyValueServiceConfig config) {
        ...
        for (InetSocketAddress endPointAddrt : thriftEndPoints) {
            Optional<CassandraJmxCompactionClient> client = new CassandraJmxCompactionClient.Builder(endPointAddrt.getHostString(), jmxPort)
